...
_data_frame = pd.DataFrame(prediction, columns=['tempvaluepredicted'])
...
_write_client.write(bucket, my_org, record = _data_frame, data_frame_measurement_name = 'PredictionTemperature')
